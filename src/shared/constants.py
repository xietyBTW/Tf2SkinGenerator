...
#: Пользователь выбрал «Скопировать главную» — на материал ложится копия главной
#: текстуры (у BLU-материала — его RED-пары). Раньше этот ответ шёл как None и
#: сливался с «ничего не выбрано»: материал молча выпадал из мода.
EXTRA_TEX_USE_MAIN = "__USE_MAIN__"
