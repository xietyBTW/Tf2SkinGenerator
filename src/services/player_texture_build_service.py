...
Единая реализация для рук и скина тела: разница только в том, какую функцию
вызывать для получения списка текстур, поэтому список передаётся снаружи
через texture_getter.
